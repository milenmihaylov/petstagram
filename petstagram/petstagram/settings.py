...
AWS_S3_CUSTOM_DOMAIN = 'd11j0c03cc38j0.cloudfront.net'

AWS_CLOUDFRONT_KEY_ID = getenv('AWS_CLOUDFRONT_KEY_ID').strip()
AWS_CLOUDFRONT_KEY = getenv('AWS_CLOUDFRONT_KEY').strip()
